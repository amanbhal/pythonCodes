# drawing health bars and damaging
...
def missile_shoot(x,y,power,enemyTankX,enemyTankY,turretAngle=math.radians(45)):
		...
		for event in pygame.event.get(): 	#event handling loop
			...
			if event.type == pygame.KEYDOWN:
				...
				if event.key == pygame.K_a:
					...
					missile_shoot(mainTankX,mainTankY,power,enemyTankX,enemyTankY,turretAngle)
					enemy_missile_shoot(enemyTankX,enemyTankY,mainTankX,mainTankY)
